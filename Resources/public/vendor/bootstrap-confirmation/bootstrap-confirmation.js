+function ($) {
    ...
    Confirmation.prototype.setContent = function () {
        ...
        if (options.onConfirm == Confirmation.DEFAULTS.onConfirm) {
            $btnOk.attr('href', this.getHref());
            $btnOk.attr('target', this.getTarget());
        }
    ...
    $.fn.confirmation = function (option) {
        ...
        return this.each(function () {
            ...
            options.href = $this.context.href;
            options.btnOkLabel = $this.context.dataset['originalTitle'];
